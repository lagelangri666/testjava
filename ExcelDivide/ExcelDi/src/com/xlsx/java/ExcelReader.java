...
//        }
    ...
    private static ExcelDataVO convertRowToData(Row row) {
        ...
        if (null == yearStr || "".equals(yearStr)) {
            ...
            resultData.setYear(Integer.parseInt(yearStr));
        }
        //获取月
        ...
        if (null == monthStr || "".equals(monthStr)) {
            ...
            resultData.setH(Integer.parseInt(monthStr));
        }
        //获取日
        ...
        if (null == dayStr || "".equals(dayStr)) {
            ...
            resultData.setDay(Integer.parseInt(dayStr));
        }
        ...
        if (null == atempStr || "".equals(atempStr)) {
            ...
            double atempDouble = atemp/10;
            String doubleAtemp=String.format("%.1f",atempDouble);
            resultData.setAtemp(Double.parseDouble(doubleAtemp));
        }
        //获取最高气温
        String maxTempStr = convertCellValueToString(cell);
        if (null == maxTempStr || "".equals(atempStr)) {
            resultData.setAtemp(null);
        } else {
            Integer maxTemp = Integer.valueOf(maxTempStr);
            double maxTempDouble = maxTemp/10;
            String doubleMaxtemp=String.format("%.1f",maxTempDouble);
            resultData.setAtemp(Double.parseDouble(doubleMaxtemp));
        }
        //获取最低气温
        ...
        if (null == maxTempStr || "".equals(atempStr)) {
            ...
            Integer minTemp = Integer.valueOf(maxTempStr);
            double minTempDouble = minTemp/10;
            String doubleMintemp=String.format("%.1f",minTempDouble);
            resultData.setAtemp(Double.parseDouble(doubleMintemp));
        }
